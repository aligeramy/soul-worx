...
async function seedCommunity() {
    ...
    const channels = await db.insert(communityChannels).values([
      {
        ...
        thumbnailImage: "/optimized/basketball-thumb.jpg",
        requiredTierLevel: 1,
        isFeatured: true,
      ...
      },
      {
        ...
        thumbnailImage: "/optimized/career-thumb.jpg",
        requiredTierLevel: 1,
        isFeatured: true,
      ...
      },
      {
        ...
        thumbnailImage: "/optimized/scholarship-thumb.jpg",
        requiredTierLevel: 2,
        isFeatured: true,
      ...
      },
      {
        ...
        thumbnailImage: "/optimized/life-skills-thumb.jpg",
        requiredTierLevel: 1,
        isFeatured: false,
  ...
  if (existingVideos.length > 0) {
      ...
      await db.insert(videos).values([
    {
      ...
      thumbnailUrl: "/optimized/dribbling-thumb.jpg",
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/shooting-thumb.jpg",
      duration: 1200,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/defense-thumb.jpg",
      duration: 1080,
      isFirstEpisode: false,
      episodeNumber: 3,
      seasonNumber: 1,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/game-iq-thumb.jpg",
      duration: 1500,
      isFirstEpisode: false,
      episodeNumber: 4,
      seasonNumber: 1,
  ...
  // Career Development Videos
      ...
      await db.insert(videos).values([
    {
      ...
      thumbnailUrl: "/optimized/resume-thumb.jpg",
      duration: 720,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/interview-thumb.jpg",
      duration: 1800,
      isFirstEpisode: false,
      episodeNumber: 2,
      seasonNumber: 1,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/networking-thumb.jpg",
      duration: 960,
      isFirstEpisode: false,
      episodeNumber: 3,
      seasonNumber: 1,
  ...
  // Scholarship Videos
      ...
      await db.insert(videos).values([
    {
      ...
      thumbnailUrl: "/optimized/scholarship-101-thumb.jpg",
      duration: 1200,
      isFirstEpisode: true, // FREE
      episodeNumber: 1,
      seasonNumber: 1,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/highlight-thumb.jpg",
      duration: 1440,
      isFirstEpisode: false,
      episodeNumber: 2,
      seasonNumber: 1,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/coach-contact-thumb.jpg",
      duration: 900,
      isFirstEpisode: false,
      episodeNumber: 3,
      seasonNumber: 1,
  ...
  // Life Skills Videos
      ...
      await db.insert(videos).values([
    {
      ...
      thumbnailUrl: "/optimized/finance-thumb.jpg",
      duration: 1080,
      isFirstEpisode: true, // FREE
      episodeNumber: 1,
      seasonNumber: 1,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/time-management-thumb.jpg",
      duration: 840,
      isFirstEpisode: false,
      episodeNumber: 2,
      seasonNumber: 1,
    ...
    },
    {
      ...
      thumbnailUrl: "/optimized/mental-health-thumb.jpg",
      duration: 1200,
      isFirstEpisode: false,
      episodeNumber: 3,
      seasonNumber: 1,
