...
export default function SignInScreen() {
  ...
  async function openSignup() {
    // Redirect to web app for signup (Spotify-style)
    const signupUrl = 'https://beta.soulworx.ca/signup?mobile=true';
    const { openBrowserAsync } = await import('expo-web-browser');
    await openBrowserAsync(signupUrl);
  }
    ...
    >
      ...
      <View style={styles.formSection}>
        ...
        <View style={styles.form}>
          ...
          {/* Create Account Button - Redirects to Web */}
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  heroSection: {
    height: height * 0.5,
    backgroundColor: SoulworxColors.beige, // Brown background
