    ...
    <div className="bg-brand-bg-darker min-h-screen">
      ...
      <section className="bg-neutral-50 px-0 py-0 md:py-32 md:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="lg:hidden relative aspect-[4/5] overflow-hidden rounded-none  md:rounded-3xl ">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 text-white">
              <div className="inline-block px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-4 w-fit">
                <span className="text-sm font-semibold uppercase tracking-wider text-white">The Book</span>
              </div>
              <h2 className="text-4xl font-crimson font-normal tracking-tight mb-4">
                The Ripple Effect
              </h2>
              <p className="text-lg font-normal leading-relaxed font-crimson mb-6">
              ...
              <div className="flex flex-col gap-4 mb-10">
                <a href="https://www.amazon.ca/Ripple-Effect-Indiana-Rotondo/dp/1039192823" target="_blank" rel="noopener noreferrer">
                  <button className="group relative font-crimson font-normal px-10 py-5 bg-white text-brand-bg-darker text-xl rounded-md shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden w-full">
