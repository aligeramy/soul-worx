...
UPDATE community_channel SET "videoCount" = (SELECT COUNT(*) FROM video WHERE "channelId" = (SELECT id FROM community_channel WHERE slug = 'ball-handling-fundamentals' LIMIT 1)) WHERE slug = 'ball-handling-fundamentals';
...
UPDATE community_channel SET "videoCount" = (SELECT COUNT(*) FROM video WHERE "channelId" = (SELECT id FROM community_channel WHERE slug = 'shooting-fundamentals-solo-practice' LIMIT 1)) WHERE slug = 'shooting-fundamentals-solo-practice';