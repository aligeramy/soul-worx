...
export function SoulworxLoginForm() {
        ...
        {isEmailLogin ? (
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <button
              ...
              className="text-sm text-neutral-600 hover:text-neutral-900 w-full"
            >
          ...
          <>
            ...
            <Field>
              <Button
                ...
                type="button"
                className="w-full"
                onClick={() => signIn("google", { callbackUrl: "/onboarding/interest" })}
              >
